...
@if($errors->any())
  ...
  @endif
              <form class="card" method="post" action="{{route('edituser',['id'=>$users->id])}}">
              {{csrf_field()}}
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      <input type="email" class="form-control" value="{{ $users->email }}" aria-describedby="emailHelp" placeholder="Enter email">
