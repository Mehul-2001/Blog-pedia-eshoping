        ...
        <div class="row s_product_inner">
              ...
              >
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img
                      class="d-block w-100"
                      src="{{asset('/gadget/image/' .$gadgetdetailss->gadget_image) }}"
                      alt="{{$gadgetdetailss->gadget_name}}"
                    />
                  </div>
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="s_product_text">
              <h3>{{$gadgetdetailss->gadget_name}}</h3>
              <h2>Rs. {{$gadgetdetailss->gadget_price}}</h2>
              <ul class="list">
                <li>
                  <a class="active" href="#">
              ...
              <p>{{$gadgetdetailss->gadget_description}}</p>
              ...
              <div class="card_area">
                <a class="main_btn" href="{{route('addcart',$gadgetdetailss->id)}}">Add to Cart</a>
