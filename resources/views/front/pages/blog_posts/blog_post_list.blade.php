              ...
              <div class="col-lg-8 mb-5 mb-lg-0">
                  ...
                  <article class="blog_item">
                        <div class="blog_item_img">
                          <img class="card-img rounded-0" src="{{asset('/post/image/' .$post_detailss->post_image) }}" alt="">
                          <a href="#" class="blog_item_date">
                            <h3>{{$post_detailss->created_at->todatestring()}}</h3>
              
                          </a>
                        </div>
                        
                        <div class="blog_details">
                            <a class="d-inline-block" href="{{route('single_blogpost',['id'=>$post_detailss->id])}}">
                                <h2>{{$post_detailss->post_name}}</h2>
                            </a>
                            <!-- <p>{{$post_detailss->post_description}}</p> -->
                            <ul class="blog-info-link">
                              <li><a href="#"><i class="ti-user"></i>{{$post_detailss->post_topic}}</a></li>
                  ...
                  <div class="blog_right_sidebar">
                    ...
                    @endforeach()
                      ...
                      <aside class="single_sidebar_widget tag_cloud_widget">
                          ...
                          @foreach($category as $categorys)
                            <li>
                                <a href="#" class="d-flex">{{$categorys->name}}</a>
                            </li>
                    @endforeach()
