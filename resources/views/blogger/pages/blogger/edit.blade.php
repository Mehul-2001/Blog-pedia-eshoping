              ...
              <form class="card" method="post" action="#">
                ...
                <div class="card-body">
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      <input type="text"  name="name" class="form-control" value="{{ Auth::user()->name }}" placeholder="Enter name" readonly>
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <div>
                      <input type="email" class="form-control" value="{{ Auth::user()->email }}" aria-describedby="emailHelp" placeholder="Enter email" readonly>
                  ...
                  <div class="mb-3">
                   ...
                   <div class="mb-3">
                    ...
                    <div>
                      <input type="text"  name="twitter" class="form-control" placeholder="www.twitter.com">
                    </div>
                  </div>
